...
def save_known_faces():
	# Delete the .dat file to restart the process
...
def main_loop():
    ...
    # If you are using a virtual machine and get an error then 
    # the webcam probably isn't configured in the VM.
    # Use an existing video in this format in same directory 
    # if you don't want to use webcam
